...
my $maxCPU = 20;                 # the maximum number of process threads; you may change this
...
for my $chr ((1..22, 'X', 'Y')) {
  ...
  for my $chunk (1..4) {
    ...
    # If this is a child process, execute mach
      ...
      my $command = "sleep 3; echo 'mach; chr${chr}, chunk${chunk}'";
...
for my $chr ((1..22, 'X', 'Y')) {
  ...
  for my $chunk (1..4) {
    ...
    # If this is a child process, execute mach
      ...
      my $command = "sleep 3; echo 'minimac; chr${chr}, chunk${chunk}'";
...
# Args: \@array, a ref to a list of child pids
